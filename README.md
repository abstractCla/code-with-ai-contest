...
![主页面与2D地图](screenshots/main_dashboard.png)

### 2. 3D地图与统计图表

展示了3D HexagonLayer 可视化效果（高度随下载速率变化）、频段分布柱状图和终端类型占比柱状图。

![3D地图与统计图表](screenshots/3d_map_charts.png)

### 3. RSRP-SINR关系分析

展示了RSRP与SINR关系散点图和原始数据预览表格（前20行）。

![RSRP-SINR关系分析](screenshots/rsrp_sinr_scatter.png)

### 4. 频段筛选器

展示了频段筛选下拉菜单，选项包括全部、n28、n41、n78。

![频段筛选器](screenshots/band_filter.png)

### 5. 终端类型筛选器

展示了终端类型筛选下拉菜单，选项包括全部、CPE、IoT、Smartphone。

![终端类型筛选器](screenshots/terminal_filter.png)
